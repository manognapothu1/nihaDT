  ...
  return (
    <div className="mx-auto w-full max-w-lg rounded-[32px] bg-white px-8 py-10 shadow-lg shadow-slate-200">
      <div className="space-y-3 text-center">
        <p className="text-sm uppercase tracking-[0.3em] text-sky-600">Campus helpdesk</p>
        <h1 className="text-3xl font-semibold text-slate-900">Login to your account</h1>
        <p className="text-sm text-slate-500">Use your student or admin credentials to continue.</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-slate-500">
        New student? <Link to="/register" className="font-semibold text-sky-600">Register here</Link>
      </p>
